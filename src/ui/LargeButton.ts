...
const defaultLargeButtonOptions = {
  ...
  width: 301,
  height: 112,
  defaultImage: "common-action-button-bg",
  hoverImage: "common-action-button-bg",
  pressedImage: "common-action-button-bg",
};
...
export class LargeButton extends FancyButton {
  ...
  constructor(options: Partial<LargeButtonOptions> = {}) {
    ...
    const defaultView = new NineSliceSprite({
      texture: Sprite.from(opts.defaultImage).texture,
      leftWidth: 36,
      topHeight: 42,
      rightWidth: 36,
      bottomHeight: 52,
    ...
    const hoverView = new NineSliceSprite({
      texture: Sprite.from(opts.hoverImage).texture,
      leftWidth: 36,
      topHeight: 42,
      rightWidth: 36,
      bottomHeight: 52,
    ...
    const pressedView = new NineSliceSprite({
      texture: Sprite.from(opts.pressedImage).texture,
      leftWidth: 36,
      topHeight: 42,
      rightWidth: 36,
      bottomHeight: 52,
